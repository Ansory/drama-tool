...
// FIX: AutoUpdate tidak ada, diganti UpdateNotification (Settings)
...
function App() {
    ...
    const tabs = [
        ...
        // FIX: AutoUpdate -> Settings (berisi update settings)
    ...
    return (
        <div className="app">
            {/* Update notification banner (muncul otomatis jika ada update) */}
            <UpdateNotification />
